...
<body class="text-center">
  <form class="form-signin" method="POST" action="/login">
    ...
    <h1 class="h3 mb-3 font-weight-normal">Login Petugas</h1>
    ...
    <button class="btn btn-lg btn-success btn-block" type="submit"><i class="fas fa-sign-in-alt"></i> Login</button>
    <p class="text-center mt-2">Siswa login <a href="/"><u>disini</u></a></p>
