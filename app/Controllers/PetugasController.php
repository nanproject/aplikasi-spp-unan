...
{	
	...
	public function login()
	{
		...
		if(count($Userpetugas)==1){
			...
			return redirect()->to('/petugas')->with('gagal-login','<div class="alert alert-danger">username atau password salah</div>');
	...
	public function simpanPetugas(){
		...
		return redirect()->to('/petugas/tampil')->with('pesan','<div class="alert alert-success">Petugas baru berhasil di tambahkan</div>');;
	}
	...
	public function hapusPetugas($idPetugas){
		...
		if(petugasInPembayaran($idPetugas)==0){
			...
			return redirect()->to('/petugas/tampil')->with('pesan','<div class="alert alert-success">Petugas berhasil di hapus</div>');;
		} else {
			return redirect()->to('/petugas/tampil')->with('pesan','<div class="alert alert-danger">Gagal Hapus ! User tersebut telah melakukan proses input data pembayaran</div>');
		}
	...
	public function updatePetugas(){
		...
		return redirect()->to('/petugas/tampil')->with('pesan','<div class="alert alert-success">Data petugas berhasil di update</div>');;
	}
}
